...
param policyDefinitionName string = 'SFI-W1-Def-ML-RequireDiagnosticSettings'
param displayName string = 'Azure Machine Learning workspaces should have diagnostic settings configured'
param policyDescription string = 'This policy ensures that Azure Machine Learning workspaces have diagnostic settings configured for comprehensive logging and monitoring, meeting SFI-W1 audit and compliance requirements.'
