...
param policyDefinitionName string = 'SFI-W1-Def-CogSvc-RequireManagedIdentity'
param displayName string = 'Azure Cognitive Services should use managed identity'
param policyDescription string = 'This policy ensures that Azure Cognitive Services accounts use managed identity for secure authentication and access to Azure resources, meeting SFI-W1 identity and access management requirements.'
