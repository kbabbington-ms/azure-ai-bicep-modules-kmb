...
param policyDefinitionName string = 'SFI-W1-Def-CogSvc-RequireCustomerManagedKeys'
param displayName string = 'Azure Cognitive Services should use customer-managed keys'
param policyDescription string = 'This policy ensures that Azure Cognitive Services accounts use customer-managed encryption keys for enhanced data protection and sovereignty, meeting SFI-W1 data protection requirements.'
...
var policyParameters = {
  ...
  requireKeyRotation: {
    ...
    metadata: {
      ...
      description: 'Whether to require automatic key rotation policies'
    }
    defaultValue: true
  }
}
