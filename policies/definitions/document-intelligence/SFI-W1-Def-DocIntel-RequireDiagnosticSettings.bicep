...
param policyDefinitionName string = 'SFI-W1-Def-DocIntel-RequireDiagnosticSettings'
param displayName string = 'Azure Document Intelligence should have diagnostic settings configured'
param policyDescription string = 'This policy ensures that Azure Document Intelligence accounts have diagnostic settings configured for comprehensive logging and monitoring, meeting SFI-W1 audit and compliance requirements.'
