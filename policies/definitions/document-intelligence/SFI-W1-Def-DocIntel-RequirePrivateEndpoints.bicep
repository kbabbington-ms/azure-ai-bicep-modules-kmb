...
param policyDefinitionName string = 'SFI-W1-Def-DocIntel-RequirePrivateEndpoints'
param displayName string = 'Azure Document Intelligence should use private endpoints'
param policyDescription string = 'This policy ensures that Azure Document Intelligence (Form Recognizer) accounts use private endpoints for secure communication and network isolation, meeting SFI-W1 zero-trust architecture requirements.'
...
var policyParameters = {
  ...
  allowedLocations: {
    ...
    metadata: {
      ...
      description: 'The list of allowed locations for Document Intelligence accounts'
    }
    defaultValue: [
      'eastus'
      'eastus2'
