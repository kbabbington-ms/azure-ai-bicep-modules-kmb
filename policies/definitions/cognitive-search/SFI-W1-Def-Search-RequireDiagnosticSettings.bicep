...
param policyDefinitionName string = 'SFI-W1-Def-Search-RequireDiagnosticSettings'
param displayName string = 'Azure Cognitive Search should have diagnostic settings configured'
param policyDescription string = 'This policy ensures that Azure Cognitive Search services have diagnostic settings configured for comprehensive logging and monitoring, meeting SFI-W1 audit and compliance requirements.'
